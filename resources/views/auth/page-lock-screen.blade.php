                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="brand-logo mb-3 text-center">
										<img class="logo-abbr dark-logo" width="200" src="./images/logo-full.png" alt="">
										<img class="logo-abbr light-logo text-center m-auto" width="200" src="./images/logo-full-light.png" alt="">
									</div>
