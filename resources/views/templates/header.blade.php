                        ...
                        <li class="nav-item">
                            <div class="dropdown header-profile2">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        <div class="d-flex align-items-center sidebar-info">
                                            <div>
                                                <h4 class="mb-0">{{ session('email') }}</h4>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="{{ route('index') }}" class="dropdown-item ai-icon">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('customers') }}">User List</a></li>
                        <li><a href="{{ route('withdrawal.requests') }}">Withdrawal Requests</a></li>
                        <li><a href="{{ route('set_swaps') }}">Set Swaps</a></li>
