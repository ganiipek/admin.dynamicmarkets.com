                            ...
                            <div class="col-xl-12">
                                <div class="page-titles">
                                    ...
                                    <div class="right-area folder-layout-tab">
                                        <button class="btn btn-primary">New Invoice <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        ...
                                                        <div class="user-details">
                                                            ...
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="dropdown">
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/2.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Jacob Jack</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/3.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Jordan Nico</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/4.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Gibs Gibsy</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/5.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/6.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Core</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/7.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Sodara</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/8.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Smith</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/9.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Nico</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/10.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Samantha</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/11.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Adja</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card contact_list">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <img src="./images/contacts/12.jpg" alt="">
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name">Johnny</h4>
                                                            <span class="number">+1234567890</span>
                                                            <span class="mail">jordan@mail.com</span>
                                                        </div>
                                                    </div>
