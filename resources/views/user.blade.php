                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive  patient">
                                            <table
                                                ...
                                                <tbody>
                                                    @foreach ($withdrawal_requests as $key => $withdrawal)
                                                    <tr>
                                                        <td class="whitesp-no">{{$withdrawal->Client_ID}}</td>
                                                        <td class="whitesp-no fs-14 font-w400">
                                                            {{$withdrawal->Request_Date}}</td>
                                                        ...
                                                        <td class="whitesp-no">
                                                            <center>
                                                                ...
                                                                @endif
                                                                @if($withdrawal->Withdrawal_Status == "Rejected")
                                                                ...
                                                                @endif
                                                                @if($withdrawal->Withdrawal_Status == "Completed")
                                                        ...
                                                        <td class="doller">$ {{$withdrawal->Requested_Amount}} </td>
                                                        <td class="whitesp-no">
                                                            <center>
                                                                <a
                                                                    href="{{ route('withdrawal_detail', ['user_id'=>$withdrawal->User_ID,'id'=>$withdrawal->Withdrawal_ID]) }}"><span
