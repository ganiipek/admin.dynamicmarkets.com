<x-app-layout>
    <x-slot name="slot">
                                                        ...
                                                        <td class="">
                                                            <div class="mb-3">
                                                                <button type="button" class="btn btn-primary"
                                                                    id="editTradingAccountModalShowButton"
                                                                    data-login="{{ $client->login }}">Edit</button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    @endforeach
        ...
        <div class="modal fade" id="editTradingAccountModal" tabindex="-1"
            aria-labelledby="editTradingAccountModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-account-enabled">User allowed to
                                            connect</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-change-password">User allowed to change
                                            password</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-one-time-password">User allowed to use one-time
                                            password</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-trade-disabled">User trading disabled</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-trade-trailing">User trailing stops are
                                            allowed</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-check custom-checkbox mb-3">
                                        ...
                                        <label class="form-check-label"
                                            for="editTradingAccountModal-virtual-hosting">User allowed to use sponsored
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="editTradingAccountModalSaveButton" type="button"
