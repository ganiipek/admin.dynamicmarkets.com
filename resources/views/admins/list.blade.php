                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table-responsive table display dataTablesCard text-black dataTable"
                                        id="list">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        @if($show_buttons['delete_admin'])
                                                        <a class="btn btn-danger" data-toggle="modal"
                                                            href="#deleteAdminModal_{{ $admin->id }}"><i
                                            ...
                                            @if($show_buttons['delete_admin'])
                                            <div class="modal fade" id="deleteAdminModal_{{ $admin->id }}" tabindex="-1"
                                                role="dialog" aria-labelledby="deleteAdminModalTitle_{{ $admin->id }}"
                                                aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a type="button" class="btn btn-danger"
                                                                id="{{ $admin->id }}" name="deleteAdminButton">Hesabı
                                                                kaldır</a>
                                                        </div>
                                                    </div>
                                                </div>
